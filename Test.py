from os import read, write, fstat; from sys import stdin, stdout, setrecursionlimit; from io import BytesIO, IOBase; BS = 8192
class FastIO(IOBase):
    nl = 0
...
M, N = int(1e9) + 7, int(2e5) + 5; setrecursionlimit(M)
