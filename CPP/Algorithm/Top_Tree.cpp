...
struct top_tree_node
{
    ...
    void downdate()
    {
        ...
        {
            if (c[0])
                c[0]->do_subtree_increment(subtree_lazy);
            if (c[1])
                c[1]->do_subtree_increment(subtree_lazy);
            if (c[2])
                c[2]->do_subtree_increment(subtree_lazy);
            subtree_lazy = 0;
        }
